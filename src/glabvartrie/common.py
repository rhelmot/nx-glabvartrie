...
class LabVarDiGraphMatcher(Generic[N], DiGraphMatcher):
    def __init__(
        self,
        g1: nx.DiGraph[N],
        g2: nx.DiGraph[N],
        ...
        super().__init__(
            g1,
            g2,
            node_match=lambda a1, a2: a1[node_label_attr] == a2[node_label_attr],
            edge_match=lambda a1, a2: a1[edge_label_attr] == a2[edge_label_attr],
        )

class LabVarDiGraphExpansionMatcher(Generic[N], DiGraphMatcher):
    def __init__(
        self,
        g1: nx.DiGraph[N],
        g2: nx.DiGraph[N],
        node_label_attr: str,
        edge_label_attr: str,
        base_mapping: Mapping[N, N],
    ):
        super().__init__(
            g1,
            g2,
            node_match=lambda a1, a2: base_mapping[a1["_self"]] == a2["_self"] if a1["_self"] in base_mapping else a1[node_label_attr] == a2[node_label_attr],
            edge_match=lambda a1, a2: a1[edge_label_attr] == a2[edge_label_attr],
        )
